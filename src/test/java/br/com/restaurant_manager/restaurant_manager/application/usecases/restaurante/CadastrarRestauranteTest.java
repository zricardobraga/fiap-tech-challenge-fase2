...
import br.com.restaurant_manager.restaurant_manager.application.usecases.proprietario.CadastrarProprietario;
...
public class CadastrarRestauranteTest {
    ...
    void deveCadastrarRestaurante(){
        ...
        when(repositorioDeRestaurante.cadastrar(restaurante)).thenReturn(restaurante);
        ...
        verify(repositorioDeRestaurante, times(1)).cadastrar(restaurante);
    }
