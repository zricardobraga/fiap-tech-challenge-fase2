...
import br.com.restaurant_manager.restaurant_manager.application.usecases.proprietario.AtualizarProprietario;
...
public class AtualizarRestauranteTest {
    ...
    void deveAtualizarRestaurante(){
        ...
        when(repositorioDeRestaurante.atualizar(1L, restaurante)).thenReturn(restaurante);

        Restaurante restauranteASerAtualizado = atualizarRestaurante.atualizarRestaurante(1L, restaurante);

        assertEquals("Restaurante Sabor Caseiro", restauranteASerAtualizado.getNome());
        verify(repositorioDeRestaurante).atualizar(1L, restaurante);
    }
