...
public class ClienteEntity {
    ...
    public ClienteEntity(Long id, String nome, String email, String login, String senha, Date ultimaAlteracao, Endereco endereco, TipoUsuarioEntity tipoUsuarioEntity) {
        this.id = id;
        this.nome = nome;
        this.email = email;
        this.login = login;
